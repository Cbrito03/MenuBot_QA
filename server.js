...
app.get('/', (req, res) => {
  ...
  var respuesta = "Bienvenido al menú Bot de <strong>Costa Rica</strong>, las opciones disponibles son: <br>";
      respuesta += '<ul> <li> <strong> WhastApp "/wa/message" <br> </strong> </li>';
      ...
      respuesta += '<ul> <li> <strong> Facebook : "/fb/message" <br> </strong> </li>';
      ...
      respuesta += '<ul> <li> <strong> Twitter : "/tw/message" <br> </strong> </li>';
